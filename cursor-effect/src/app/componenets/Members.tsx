...
const Members = () => {
  ...
  return (
    <div
      className="w-[50vw] h-[75vh] flex flex-col items-center justify-center gap-4 cursor-pointer"
      onClick={navigateToMembers} 
    >
      
      <motion.div
        className="h-[50vh] w-[20vw] relative overflow-hidden rounded-2xl shadow-lg border-2 border-[#00a3a3]"
        initial={{ scale: 1 }}
