...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col pt-5 items-center lg:pt-12 relative">
      ...
      {/* Signup Form */}
      <div className="p-4 mx-2 sm:border-[2px] border-[#1B7774] w-[90%] m max-w-[400px] bg-black rounded-3xl h-auto flex flex-col justify-center items-center">
